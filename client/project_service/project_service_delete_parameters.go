...
// WithName adds the name to the project service delete params
func (o *ProjectServiceDeleteParams) WithName(name string) *ProjectServiceDeleteParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the project service delete params
func (o *ProjectServiceDeleteParams) SetName(name string) {
	o.Name = name
}
