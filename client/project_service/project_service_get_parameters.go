...
// WithName adds the name to the project service get params
func (o *ProjectServiceGetParams) WithName(name string) *ProjectServiceGetParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the project service get params
func (o *ProjectServiceGetParams) SetName(name string) {
	o.Name = name
}
